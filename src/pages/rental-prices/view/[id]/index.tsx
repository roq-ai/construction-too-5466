...
import { getRentalPriceById } from 'apiSdk/rental-prices';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Rental Price Detail View
          </Text>
          {hasAccess('rental_price', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/rental-prices/edit/${data?.id}`} passHref legacyBehavior>
              <Button
