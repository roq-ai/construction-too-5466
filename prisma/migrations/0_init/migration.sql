...
CREATE TABLE "rental_price" (
    ...
    CONSTRAINT "rental_price_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "rental_price" ADD CONSTRAINT "rental_price_tool_id_fkey" FOREIGN KEY ("tool_id") REFERENCES "tool"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
